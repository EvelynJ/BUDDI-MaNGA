...
pro buddi_plot_results_poly2, dir,plate_ifu,ONECOMP=onecomp,TWOCOMP=twocomp

if keyword_set(ONECOMP) then decomp_dir='IFU_decomp_1comp/' else decomp_dir='IFU_decomp_2comp/'
fits_read,dir+decomp_dir+'decomposed_data_poly2/decomposed_data_ergs/component1_cube.fits',c1_in,h_c1
fits_read,dir+decomp_dir+'decomposed_data_poly2/decomposed_data_ergs/original_cube.fits',orig_in
fits_read,dir+decomp_dir+'decomposed_data_poly2/decomposed_data_ergs/bestfit_cube.fits',bestfit_in
fits_read,dir+decomp_dir+'decomposed_data_poly2/decomposed_data_ergs/residuals_cube.fits',resid_in
fits_read,dir+decomp_dir+'decomposed_data_poly2/decomposed_data_ergs/residual_sky_cube.fits',sky_in
...
fits_read,dir+decomp_dir+'decomposed_data_poly2/decomposed_data_ergs/component1_flux.fits',temp,h_temp
...
if keyword_set(TWOCOMP) then begin
  fits_read,dir+decomp_dir+'decomposed_data_poly2/decomposed_data_ergs/component2_cube.fits',c2_in
...
set_plot,'ps'
;loadct,0
device,file=dir+decomp_dir+'decomposed_data_poly2/decomposed_data_ergs/'+plate_ifu+'_overview.eps',ysize=11,xsize=8,/inches,/color
!P.thick=2
!p.charthick=2
!p.charsize=1
!p.multi=[0,3,6]
...
nband=12
res_free=read_sersic_results_2comp(dir+decomp_dir+'binned_images_poly2/imgblock_free.fits', nband, bd=bd) 
res=read_sersic_results_2comp(dir+decomp_dir+'binned_images_poly2/imgblock.fits', nband, bd=bd)
if keyword_set(TWOCOMP) then begin
  decomp_dir2='IFU_decomp_2comp/'
  bd=1
  res2_free=read_sersic_results_2comp(dir+decomp_dir2+'binned_images_poly2/imgblock_free.fits', nband, bd=bd)
  res2=read_sersic_results_2comp(dir+decomp_dir2+'binned_images_poly2/imgblock.fits', nband, bd=bd)
endif

images = file_search(dir+decomp_dir+'binned_images_poly2/image_*.fits',COUNT=nfiles)
